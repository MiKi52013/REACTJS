...
import { LANGUAGES, CRUD_ACTIONS, CommonUtils }
    from "../../../utils";
...
class UserRedux extends Component {
    ...
    openPreviewImage = () => {
        ...
        //nếu o ảnh rỗng thì click ko ra
        this.setState({
            isOpen: true
        })
    }
    ...
    checkValidateInput = () => {
        ...
        let arrCheck = ['email', 'password', 'firstName', 'lastName',
            'phoneNumber', 'address',] //thông tin bắt buộc phải nhập
                        ...
                        <div className='row'>
                            ...
                            <div className='col-12'>
                                <button className={this.state.action === CRUD_ACTIONS.EDIT ?
                                    "btn btn-warning" : "btn btn-primary"} //btn-warning: lấy hiệu ứng nút màu vàng
